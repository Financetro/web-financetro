    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-primary text-primary-foreground hover:bg-primary-hover shadow": variant === "default",
            ...
            "bg-card text-card-foreground shadow-sm hover:bg-card-hover border border-border": variant === "secondary",
